 ...
 * Demonstrates static generation for public pages
 */
...
export async function generateMetadata(): Promise<Metadata> {
  return ssrOptimizer.generateMetadata('/login');
}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Static Generation Info (Development Only) */}
        {process.env.NODE_ENV === 'development' && (
          <div className="mt-8 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Static Generation Info (Dev Only)
            </h4>
            <p className="text-xs text-gray-600 dark:text-gray-400">
              This page is statically generated at build time for optimal performance.
              No server-side processing is required for each request.
            </p>
          </div>
        )}
      </div>
